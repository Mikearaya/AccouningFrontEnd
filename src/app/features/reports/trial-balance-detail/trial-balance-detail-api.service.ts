...
import { Sorts, DataStateChangeEventArgs } from "@syncfusion/ej2-grids";
...
export class TrialBalanceDetailApiService extends Subject<
...
> {
  ...
  getData(
    ...
    return this.httpClient
      .post(`report/trial-balance/detail`, filter)
      .pipe(
        map(
          (response: any) =>
            ({
